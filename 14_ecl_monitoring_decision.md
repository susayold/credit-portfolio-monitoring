...
P2 monitors frozen P4 ECL scenario, sensitivity, concentration and readiness outputs. Stage 2 remains a broad proxy and no prior ECL snapshot exists, so no period trend is fabricated.

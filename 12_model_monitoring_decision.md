...
P2 monitors frozen P3-derived PD/score fields and does not retrain the model. AUC, KS, Gini and calibration use matured outcomes; PSI uses fixed development bins. Latest and prior eligible periods drive EWS.

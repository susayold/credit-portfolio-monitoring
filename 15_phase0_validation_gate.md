...
PASS. Scope, portable reviewer contracts, exact upstream versions, monitoring period, maturity gates, observed/synthetic boundaries and external PBIX/DAX gates are locked before calculation.
